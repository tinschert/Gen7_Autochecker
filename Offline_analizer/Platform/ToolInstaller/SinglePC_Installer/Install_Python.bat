...
X:\Tools\venv\Scripts\pip.exe install --no-index --find-links \\abtvdfs2.de.bosch.com\ismdfs\iad\verification\ODS\ADAS_HIL_concept\Classe\Install\Python\Libraries\Libs_3.12 -r Single_PC_py_requirements.txt
