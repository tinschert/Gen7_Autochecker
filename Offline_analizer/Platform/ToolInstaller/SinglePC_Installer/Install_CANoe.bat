...
:: Version 18SP2 (18.2.65.2)
:: 03.10.2024
:: Change: Update to V.18SP2 (18.2.65.2)
...
set src=\\abtvdfs2.de.bosch.com\ismdfs\iad\verification\ODS\ADAS_HIL_concept\Classe\Install\CANoe\V18_SP2_and_hotfix
...
:Install_CANoe_USA
ECHO "USA"
call :NameSearch "Vector CANoe Family 18","CANoe\CANoeFamily\SetupCANoeFamily.exe /noGui /noReboot","18.2.65"
...
:Install_CANoe
ECHO "NOT USA"
call :NameSearch "Vector CANoe Family 18","CANoe\CANoeFamily\SetupCANoeFamily.exe /noGui /noReboot /userSettings "%cd%/CANoe_config.xml"","18.2.65"
:: Check installation and remove CANoe folder
IF %ERRORLEVEL% EQU 0 ( IF EXIST .\CANoe ( 
		 RD /S /Q ".\CANoe") )
IF %ERRORLEVEL% EQU 0 (ECHO CANoe : OK>> output.log) ELSE (ECHO CANoe : NOT OK>> output.log)
