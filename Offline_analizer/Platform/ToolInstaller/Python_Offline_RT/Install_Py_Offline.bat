...
set src=.\Python_offline_libs
GOTO Extract_Python

:: Extract the installation files
:Extract_Python
IF EXIST .\Python_offline_libs GOTO Python_Init
ECHO Extracting files
powershell -command "Expand-Archive ".\Python_offline_libs.zip" "%src%" "
:: If extraction OK .zip file will be deleted.
IF %ERRORLEVEL% NEQ 0 EXIT /b %ERRORLEVEL%
del .\Python_offline_libs.zip /F
GOTO Python_Init
...
:Start_Install_Lib
X:\Tools\venv\Scripts\python.exe -3.12 -m X:\Tools\venv\Scripts\pip.exe install %src%\setuptools-66.1.1-py3-none-any.whl
X:\Tools\venv\Scripts\python.exe -3.12 -m X:\Tools\venv\Scripts\pip.exe install %src%\psutil-5.9.4-cp36-abi3-win_amd64.whl
X:\Tools\venv\Scripts\python.exe\Tools\venv\Scripts\python.exe -3.12 -m X:\Tools\venv\Scripts\pip.exe install %src%\pywin32-306-cp312-cp312-win_amd64.whl
X:\Tools\venv\Scripts\python.exe -3.12 -m X:\Tools\venv\Scripts\pip.exe install %src%\plumbum-1.8.1-py3-none-any.whl
X:\Tools\venv\Scripts\python.exe -3.12 -m X:\Tools\venv\Scripts\pip.exe install %src%\rpyc-6.0.0-py3-none-any.whl
