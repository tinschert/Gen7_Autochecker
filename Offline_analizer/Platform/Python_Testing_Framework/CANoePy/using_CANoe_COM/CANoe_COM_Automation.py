#created by Plamen Petkov
#copyright Robert Bosch GMBH
#date : 12.July.2024
#this is a implementation for some of the basic CANoe COM Automation functions supported by Vector CANoe
#based on the help of Vector CANoe : file:///C:/Program%20Files/Vector%20CANoe%2017/Help01/CANoeCANalyzerHTML5/CANoeCANalyzer.htm#Topics/COMInterface/COMObjectHierarchy.htm?Highlight=com%20object%20hierarchy
...
class CANoeClient:
    ...
    def __init__(self):
        ...
        time.sleep(4)  # Sometimes CANoe needs some time after it is ready to execute other com commands
    ...
    def startMeasurement(self, nrOfTests=1):
        ...
        if measurement.Running is False:
            measurement.Start()
            time.sleep(30) #wait 30sec by default
            waitCycles = 0
    ...
    def executeTestsInTestConfiguration(self, test_suite, sw_variant=None):
        """
        ...
        for test_unit in range(1, test_units + 1):
            ...
            if test_unit_name in tests:
                ...
                errors_code = {0: "VerdictNotAvailable", 3: "NONE", 4: "INCONCLUSIVE", 5: "ERROR IN TEST SYSTEM"}
                                    ...
                                    for tst in test.Elements:
                                        if (tst.Enabled):
                                            ...
                                            if tst.Verdict == 1:
                                                ...
                                                other_tc_count += 1
                                                logger.error(
                                                    f"TC_ERROR#::#{el.Caption} --> {sub_tree.Caption} --> {test.Caption} --> {tst.Caption} = {errors_code[test.Verdict]} #::#")
                                            else:
                                                continue
                                else:
                                    if (test.Enabled):
                                    ...
                                    for tst in test.Elements:
                                        if (tst.Enabled):
                                            ...
                                            if tst.Verdict == 1:
                                                ...
                                                other_tc_count += 1
                                                errors_code = {0: "VerdictNotAvailable", 3: "NONE", 4: "INCONCLUSIVE",
    ...
    def executeTestModules(self, test_envs):
        ...
        verdict_manual = {0: "NotAvailable", 1: "Passed", 2: "Failed", 3: "None", 4: "Inconclusive"}
