...
def TestCase_ACC_Test():
    ...
    #capl.SetSignal("hil_drv", "target_velocity",50.0) #set Ego = 50kph
    ...
    capl.WaitForSignalInRange("hil_hvm","velocity_x", 0.00, 1.00, 25) #// check    0    kph

    capl.TestWaitForTimeout(500)

    capl.WaitForSignalInRange("hil_hvm","velocity_x", 49.00, 51.00, 25) #// check    50    kph
