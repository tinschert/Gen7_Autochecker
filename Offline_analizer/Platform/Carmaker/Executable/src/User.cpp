...
User_TestRun_Start_atEnd (void)
{
	...
	return RB_User_TestRun_Start_atEnd();
}
...
User_TestRun_Start_StaticCond_Calc (void)
{
	...
	RB_User_TestRun_Start_StaticCond_Calc();    
...
{
    return RB_User_TestRun_Start_Finalize();
}
...
User_VehicleControl_Calc (double dt)
{
	...
	//+++++++++++++++++++++++++++++++++++
	//Bosch Plugins: User_VehicleControl_Calc
	//+++++++++++++++++++++++++++++++++++

	RB_User_VehicleControl_Calc(dt);
