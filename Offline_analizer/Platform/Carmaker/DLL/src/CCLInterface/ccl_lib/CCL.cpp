...
namespace CANalyzerCANoeCLibrary
{
  ...
  namespace NDetail
  {
    ...
    void ExtractValueClass(std::string& remaining, VIAFbValueClass& valueClass)
    {
      ...
      if (sMemberKeywords.empty())
      {
        ...
        sMemberKeywords.push_back(MemberKeyword<VIAFbValueClass>(CCL_MEMBER_ANNOUNCEMENT_STATE + 1, VIAFbValueClass::eAnnouncementState, nullptr));
      }
  ...
  {
  public:
    VIASTDDECL OnEthernetPacket(VIATime time, VIAChannel channel, uint8 dir, uint32 packetSize, const uint8 *packetData);
  ...
  protected:
    ...
    virtual VIAResult AccessValue(VIAFbTypeLevel typeLevel, VIAFbTypeMemberHandle memberHandle, VIAFbValue** value) const = 0;
  ...
  protected:
    virtual VIAResult AccessValue(VIAFbTypeLevel typeLevel, VIAFbTypeMemberHandle memberHandle, VIAFbValue** value) const;
  ...
  public:
    ...
    virtual void RegisterPortObserver(VIAFbPortObserver* observer) { return VDOMemberBase::RegisterPortObserver(observer); }
  ...
  public:
    ...
    static int32_t CreateCallContextValue(cclCallContextID ctxtID, const char* memberPath, cclValueRepresentation repr);
  ...
  public:
    ...
    static int32_t CreateSignalValue(PortType* port, const char* signalName, const char* member, cclValueRepresentation repr);
  ...
  protected:
    ...
    {
      static_cast<Subclass*>(this)->RegisterCallStateObserver(VIAFbFunctionCallState::eFinalizing, &mFinalizingHandle);
    }
  ...
  public:
    ...
    virtual bool IsEqual(const IFunctionPort* other) const override { return other->GetPortID() == this->GetPortID(); }
    ...
    // handling callbacks
    virtual int32_t SetHandler(int32_t callbackIndex, VIAFbFunctionCallState state, cclCallHandler handler) override
    {
      ...
      {
        if (static_cast<Subclass*>(this)->RegisterCallStateObserver(state, &callback.mCallbackHandle) != kVIA_OK)
        {
          callback.mCallbackFunction = nullptr;
          callback.mCallbackHandle = nullptr;
  ...
  class VClientFunction : public VClientFunctionBase<VPortBase<VIAFbFunctionClientPort>, VIAFbFunctionClientObserver, VClientFunction>
  {
  public:
  ...
  class VServerFunction : public VServerFunctionBase<VPortBase<VIAFbFunctionServerPort>, VIAFbFunctionServerObserver, VServerFunction>
  {
  public:
  ...
  protected:
    VIAResult DoRegisterCallStateObserver(VIAFbDOMethodObserver* pObserver, VIAFbFunctionCallState callState, VIAFbCallbackHandle* handle);
  ...
  public:
    ...
    int32_t ConnectAsync(cclConnectionEstablishedHandler successCallback, cclConnectionFailedHandler failureCallback);
    ...
    static int32_t LookupConsumedService(cclConsumedServiceID consumedServiceID, VConsumedService*& consumedService);
  ...
  public:
    ...
    static int32_t LookupProvidedService(cclProvidedServiceID providedServiceID, VProvidedService*& providedService);
  ...
  public:
    ...
    static int32_t LookupConsumedEventGroup(cclSomeIPConsumedEventGroupID consumedEventGroupID, VConsumedEventGroup*& consumedEventGroup);
  ...
  public:
    ...
    static int32_t LookupProvidedEventGroup(cclSomeIPProvidedEventGroupID providedEventGroupID, VProvidedEventGroup*& providedEventGroup);
  ...
  public:
    ...
    static int32_t LookupEventGroupProvider(cclSomeIPEventGroupProviderID eventGroupProviderID, VEventGroupProvider*& eventGroupProvider);
...
#pragma region VEthernetPacketRequest Implementation
  ...
  VIASTDDEF VEthernetPacketRequest::OnEthernetPacket(VIATime time, VIAChannel channel, uint8 dir, uint32 packetSize, const uint8 *packetData)
  {
...
#pragma region VPortValueBase Implementation
  ...
  int32_t VPortValueEntity::InitPduSignal(const char* signalName, const char* memberPath, cclValueRepresentation repr)
  {
    return InitImplementation(signalName, memberPath, repr);
  }

  int32_t VPortValueEntity::InitImplementation(const char* signalName, const char* memberPath, cclValueRepresentation repr)
  {
    mCallbackHandle = nullptr;
  ...
  int32_t VPortValueEntity::CreateValueEntity(const char* portPath, const char* memberPath, cclValueRepresentation repr)
  {
  ...
  int32_t VPortValueEntity::CreateValueEntity(VIAFbValuePort* port, const char* memberPath, cclValueRepresentation repr)
  {
    std::unique_ptr<VPortValueEntity> valueEntity{ new VPortValueEntity(port) };
    int32_t result = valueEntity->Init(memberPath, repr);
    if (result != CCL_SUCCESS)
  ...
  inline VIAResult VPortValueEntity::AccessValue(VIAFbTypeLevel typeLevel, VIAFbTypeMemberHandle memberHandle, VIAFbValue** value) const
  {
    if (mPort == nullptr)
    {
  ...
  int32_t VDOValueEntity::CreateValueEntity(const char* portPath, const char* memberPath, cclValueRepresentation repr)
  {
  ...
  VIAResult VDOValueEntity::AccessValue(VIAFbTypeLevel typeLevel, VIAFbTypeMemberHandle memberHandle, VIAFbValue** value) const
  {
    if (!mMember)
      return kVIA_ObjectInvalid;
    switch (mValueClass)
  ...
  VDOValueEntity::VDOValueEntity(VIAFbDOMember* pDOMember)
    : VValueBase()
    , VDOMemberBase(pDOMember)
    , mValueClass(ePortValue)
  {
  }
  ...
  int32_t VCallContextValue::CreateCallContextValue(cclCallContextID ctxtID, const char* memberPath, cclValueRepresentation repr)
  {
  ...
  VIAResult VCallContextValue::AccessValue(VIAFbTypeLevel typeLevel, VIAFbTypeMemberHandle memberHandle, VIAFbValue** value) const
  {
    auto* ctxt = GetCallContext();
    if (ctxt == nullptr)
      return kVIA_ObjectInvalid;
  ...
  int32_t VCallContextValue::GetEnum(int32_t* x) const
  {
    ...
    case NDetail::CallContextValueClass::eSide:
    {
      ...
      if (ctxt->GetSide(&side) != kVIA_OK)
        return CCL_INTERNALERROR;
      *x = static_cast<int32_t>((side == VIAFbFunctionCallSide::eClient) ? cclSide::CCL_SIDE_CONSUMER : cclSide::CCL_SIDE_PROVIDER);
      return CCL_SUCCESS;
    }
  ...
  VIAFbValue* VPDUSignalValue<PortType>::GetMemberValue() const
  {
    ...
    NDetail::VIAObjectGuard<VIAFbValue> signalValue;
    if (this->mPort->GetSignalValue(mSignalName.c_str(), VIAFbTypeLevel::eImpl, &(signalValue.mVIAObject)) != kVIA_OK)
      return nullptr;
  ...
  template<typename PortType>
  int32_t VPDUSignalValue<PortType>::CreateSignalValue(PortType* port, const char* signalName, const char* member, cclValueRepresentation repr)
  {
  ...
  template<typename T, typename IF, typename Subclass>
  VIAResult VClientFunctionBase<T, IF, Subclass>::HandleCallStateChanged(VIATime inTime, VIAFbCallContext* inCallContext,
                                                               VIAFbFunctionCallState inCallState)
  {
  ...
  template<typename T, typename IF, typename Subclass>
  VIAResult VServerFunctionBase<T, IF, Subclass>::HandleCallStateChanged(VIATime inTime, VIAFbCallContext* inCallContext,
                                                           VIAFbFunctionCallState inCallState)
  {
    cclCallState cclState;
    int32_t callbackIndex = VFunctionUtils::MapCallState(inCallState, cclState);
  ...
  VIAResult VMethodBase::DoRegisterCallStateObserver(VIAFbDOMethodObserver* pObserver, VIAFbFunctionCallState callState, VIAFbCallbackHandle* handle)
  {
    if (mMember != nullptr)
    {
      if (mMethod == nullptr)
...
#pragma endregion
  ...
  int32_t VConsumedService::LookupConsumedService(cclConsumedServiceID consumedServiceID, VConsumedService*& consumedService)
  {
    if (gModule == nullptr)
      return CCL_INTERNALERROR;
  ...
  int32_t VConsumedService::ConnectAsync(cclConnectionEstablishedHandler successCallback, cclConnectionFailedHandler failureCallback)
  {
    if (mPort == nullptr)
      return CCL_INTERNALERROR;
  ...
  int32_t VProvidedService::LookupProvidedService(cclProvidedServiceID providedServiceID, VProvidedService*& providedService)
  {
    if (gModule == nullptr)
      return CCL_INTERNALERROR;
  ...
  int32_t VProvidedService::ConnectAsync(cclConnectionEstablishedHandler successCallback, cclConnectionFailedHandler failureCallback)
  {
    if (mPort == nullptr)
      return CCL_INTERNALERROR;
  ...
  int32_t VAbstractConsumedServicePDU::LookupConsumedPDU(cclPDUReceiverID consumedPDUID, VAbstractConsumedServicePDU*& consumedPDU)
  {
    if (gModule == nullptr)
      return CCL_INTERNALERROR;
  ...
  int32_t VAbstractServicePDUProvider::LookupPDUProvider(cclPDUProviderID pduProviderID, VAbstractServicePDUProvider*& pduProvider)
  {
    if (gModule == nullptr)
      return CCL_INTERNALERROR;
  ...
  int32_t VAbstractConsumedEvent::LookupConsumedEvent(cclConsumedEventID consumedEventID, VAbstractConsumedEvent*& consumedEvent)
  {
    if (gModule == nullptr)
      return CCL_INTERNALERROR;
  ...
  int32_t VAbstractEventProvider::LookupEventProvider(cclEventProviderID eventProviderID, VAbstractEventProvider*& eventProvider)
  {
    if (gModule == nullptr)
      return CCL_INTERNALERROR;
  ...
  int32_t VAbstractConsumedField::LookupConsumedField(cclConsumedFieldID consumedFieldID, VAbstractConsumedField*& consumedField)
  {
    if (gModule == nullptr)
      return CCL_INTERNALERROR;
  ...
  int32_t VAbstractFieldProvider::LookupFieldProvider(cclFieldProviderID fieldProviderID, VAbstractFieldProvider*& fieldProvider)
  {
    if (gModule == nullptr)
      return CCL_INTERNALERROR;
  ...
  int32_t VConsumedEventGroup::LookupConsumedEventGroup(cclSomeIPConsumedEventGroupID consumedEventGroupID, VConsumedEventGroup*& consumedEventGroup)
  {
    if (gModule == nullptr)
      return CCL_INTERNALERROR;
  ...
  int32_t VProvidedEventGroup::LookupProvidedEventGroup(cclSomeIPProvidedEventGroupID providedEventGroupID, VProvidedEventGroup*& providedEventGroup)
  {
    if (gModule == nullptr)
      return CCL_INTERNALERROR;
  ...
  int32_t VEventGroupProvider::LookupEventGroupProvider(cclSomeIPEventGroupProviderID eventGroupProviderID, VEventGroupProvider*& eventGroupProvider)
  {
    if (gModule == nullptr)
      return CCL_INTERNALERROR;
  ...
  VNodeLayerModule::VNodeLayerModule()
    : mMeasurementPreStartHandler(nullptr)
    , mMeasurementStartHandler(nullptr)
    , mMeasurementStopHandler(nullptr)
...
int32_t cclIncrementTimerBase(int64_t newTimeBaseTicks, int32_t numberOfSteps)
{
  ...
  if (gVIAService)
  {
    ...
    switch (rc)
    {
      case kVIA_OK: return CCL_SUCCESS;
      case kVIA_ParameterInvalid: return CCL_PARAMETERINVALID;
      case kVIA_Failed: return CCL_WRONGSTATE;
      default: return CCL_INTERNALERROR;
    }
  }
  return CCL_INTERNALERROR;
}
...
int32_t cclCanOutputMessage(int32_t channel, uint32_t identifier, uint32_t flags, uint8_t dataLength, const uint8_t data[])
{
  CCL_STATECHECK(eRunMeasurement)
                                            ...
                                            void(*function) (struct cclLinPreDispatchMessage *frame))
{
  ...
  VIAResult rc = gLinBusContext[channel].mBus->CreatePreDispatchMessageRequest(&(request->mHandle), request, requestType, identifier, channel);
  if (rc != kVIA_OK)
  {
    delete request;
    if (rc == kVIA_ServiceNotRunning)
                                             ...
                                             void(*function) (struct cclLinSlaveResponse* frame))
{
  ...
  VIAResult rc = gLinBusContext[channel].mBus->CreateSlaveResponseChangedRequest(&(request->mHandle), request, requestType, identifier, channel);
  if (rc != kVIA_OK)
  {
    delete request;
    if (rc == kVIA_ServiceNotRunning)
...
int32_t cclLinSetWakeupBehavior(int32_t channel, uint32_t restartScheduler, uint32_t wakeupIdentifier, uint32_t sendShortHeader, uint32_t wakeupDelimiterLength)
{
  CCL_STATECHECK(eInitMeasurement | eRunMeasurement);
  ...
  VIAResult rc = gLinBusContext[channel].mBus->LINSetWakeupBehavior(channel, restartScheduler, wakeupIdentifier, sendShortHeader, wakeupDelimiterLength);
  if (rc != kVIA_OK)
  {
    return CCL_INTERNALERROR;
  }
...
int32_t cclConnectAsyncConsumer(cclConsumedServiceID consumedServiceID, cclConnectionEstablishedHandler success, cclConnectionFailedHandler failure)
{
  CCL_STATECHECK(eRunMeasurement);
...
int32_t cclConnectAsyncProvider(cclProvidedServiceID providedServiceID, cclConnectionEstablishedHandler success, cclConnectionFailedHandler failure)
{
  CCL_STATECHECK(eRunMeasurement);
...
int32_t cclPDUGetSubscribedConsumers(cclPDUProviderID pduProviderID, cclConsumerID* consumerBuffer, int32_t* bufferSize)
{
  CCL_STATECHECK(eRunMeasurement);
...
int32_t cclEventGetSubscribedConsumers(cclEventProviderID eventProviderID, cclConsumerID* consumerBuffer, int32_t* bufferSize)
{
  CCL_STATECHECK(eRunMeasurement);
...
int32_t cclFieldGetSubscribedConsumers(cclFieldProviderID fieldProviderID, cclConsumerID* consumerBuffer, int32_t* bufferSize)
{
  CCL_STATECHECK(eRunMeasurement);
...
int32_t cclAbstractSetEventSubscribedHandler(cclEventProviderID providerID, cclAbstractEventSubscriptionHandler handler)
{
  CCL_STATECHECK(eInitMeasurement | eRunMeasurement | eStopMeasurement);
...
int32_t cclAbstractSetEventUnsubscribedHandler(cclEventProviderID providerID, cclAbstractEventSubscriptionHandler handler)
{
  CCL_STATECHECK(eInitMeasurement | eRunMeasurement | eStopMeasurement);
...
int32_t cclAbstractSetFieldSubscribedHandler(cclFieldProviderID providerID, cclAbstractFieldSubscriptionHandler handler)
{
  CCL_STATECHECK(eInitMeasurement | eRunMeasurement | eStopMeasurement);
...
int32_t cclAbstractSetFieldUnsubscribedHandler(cclFieldProviderID providerID, cclAbstractFieldSubscriptionHandler handler)
{
  CCL_STATECHECK( eRunMeasurement);
...
int32_t cclSomeIPConsumedEventGroupGetEvents(cclSomeIPConsumedEventGroupID consumedEventGroupID, cclConsumedEventID* buffer, int32_t* bufferSize)
{
  CCL_STATECHECK(eInitMeasurement | eRunMeasurement | eStopMeasurement);
...
int32_t cclSomeIPProvidedEventGroupGetEvents(cclSomeIPProvidedEventGroupID providedEventGroupID, cclProvidedEventID* buffer, int32_t* bufferSize)
{
  CCL_STATECHECK(eInitMeasurement | eRunMeasurement | eStopMeasurement);
...
int32_t cclSomeIPEventGroupProviderGetEvents(cclSomeIPEventGroupProviderID eventGroupProviderID, cclEventProviderID* buffer, int32_t* bufferSize)
{
  CCL_STATECHECK(eInitMeasurement | eRunMeasurement | eStopMeasurement);
...
int32_t cclSomeIPConsumedEventGroupGetPDUs(cclSomeIPConsumedEventGroupID consumedEventGroupID, cclConsumedEventID* buffer, int32_t* bufferSize)
{
  CCL_STATECHECK(eInitMeasurement | eRunMeasurement | eStopMeasurement);
...
int32_t cclSomeIPProvidedEventGroupGetPDUs(cclSomeIPProvidedEventGroupID providedEventGroupID, cclProvidedEventID* buffer, int32_t* bufferSize)
{
  CCL_STATECHECK(eInitMeasurement | eRunMeasurement | eStopMeasurement);
...
int32_t cclSomeIPEventGroupProviderGetPDUs(cclSomeIPEventGroupProviderID eventGroupProviderID, cclEventProviderID* buffer, int32_t* bufferSize)
{
  CCL_STATECHECK(eInitMeasurement | eRunMeasurement | eStopMeasurement);
...
int32_t cclSomeIPConsumedEventGroupGetFields(cclSomeIPConsumedEventGroupID consumedEventGroupID, cclConsumedFieldID* buffer, int32_t* bufferSize)
{
  CCL_STATECHECK(eInitMeasurement | eRunMeasurement | eStopMeasurement);
...
int32_t cclSomeIPProvidedEventGroupGetFields(cclSomeIPProvidedEventGroupID providedEventGroupID, cclProvidedFieldID* buffer, int32_t* bufferSize)
{
  CCL_STATECHECK(eInitMeasurement | eRunMeasurement | eStopMeasurement);
...
int32_t cclSomeIPEventGroupProviderGetFields(cclSomeIPEventGroupProviderID eventGroupProviderID, cclFieldProviderID* buffer, int32_t* bufferSize)
{
  CCL_STATECHECK(eInitMeasurement | eRunMeasurement | eStopMeasurement);
...
int32_t cclSomeIPEventGroupGetNrOfSubscribedConsumers(cclSomeIPEventGroupProviderID eventGroupProviderID, int32_t* nrOfConsumers)
{
  CCL_STATECHECK(eRunMeasurement);
...
int32_t cclSomeIPEventGroupGetSubscribedConsumers(cclSomeIPEventGroupProviderID eventGroupProviderID, cclConsumerID* consumerBuffer, int32_t* bufferSize)
{
  CCL_STATECHECK(eRunMeasurement);
...
int32_t cclSomeIPSetEventGroupSubscribedHandler(cclSomeIPEventGroupProviderID eventGroupProviderID, cclSomeIPEventGroupSubscriptionHandler handler)
{
  CCL_STATECHECK(eInitMeasurement | eRunMeasurement | eStopMeasurement);
...
int32_t cclSomeIPSetEventGroupUnsubscribedHandler(cclSomeIPEventGroupProviderID eventGroupProviderID, cclSomeIPEventGroupSubscriptionHandler handler)
{
  CCL_STATECHECK(eInitMeasurement | eRunMeasurement | eStopMeasurement);
