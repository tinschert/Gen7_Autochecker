...
{
public:
    VIASTDDECL OnEthernetPacket( VIATime time, VIAChannel channel, uint8 dir, uint32 packetSize, const uint8 *packetData )=0;
};
...
public:
  ...
  */
  ...
  VIASTDDECL InitFromRawData(  uint32 /*in*/ bufferLength
  ...
  */
  ...
  VIASTDDECL Init(  uint32 messageId
                  , uint32 requestId
                  , uint8 protocolVersion
                  , uint8 interfaceVersion
                  , VMessageType messageType
                  , VReturnCode returnCode ) = 0;
  ...
  */
  ...
  VIASTDDECL Serialize(  uint32 /*in/out*/ *bufferLength   
                       , unsigned char /*out*/    *buffer) const = 0;
  ...
  */
  ...
  VIASTDDECL GetValueAsString( const char /*in*/ *valuePath, uint32 /*in/out*/ *bufferLength, unsigned char /*out*/ *value) const = 0;
  ...
  */
  ...
  VIASTDDECL SetValueAsString( const char /*in*/ *valuePath, uint32 /*in*/ bufferLength, const unsigned char /*in*/ *value) = 0;
  ...
  */
  ...
  VIASTDDECL SetValueAsInt32_2( const char /*in*/ *valuePath, int32 /*in*/ newValue, bool /*in/out*/ *valueHasChanged) = 0;
  VIASTDDECL SetValueAsInt64_2( const char /*in*/ *valuePath, int64 /*in*/ newValue, bool /*in/out*/ *valueHasChanged) = 0;
  VIASTDDECL SetValueAsDouble_2( const char /*in*/ *valuePath, double /*in*/ newValue, bool /*in/out*/ *valueHasChanged) = 0;
  VIASTDDECL SetValueAsString_2( const char /*in*/ *valuePath, uint32 /*in*/ bufferLength, const unsigned char /*in*/ *newValue, bool /*in/out*/ *valueHasChanged) = 0;
  VIASTDDECL SetValueAsPhys_2( const char /*in*/ *valuePath, double /*in*/ newValue, bool /*in/out*/ *valueHasChanged) = 0;
  VIASTDDECL SetValueAsData(const char /*in*/ *valuePath, uint32 /*in*/ bufferLengthInBits, const unsigned char /*in*/ *newValue) = 0;
  VIASTDDECL SetValueAsData_2(const char /*in*/ *valuePath, uint32 /*in*/ bufferLengthInBits, const unsigned char /*in*/ *newValue, bool /*in/out*/ *valueHasChanged) = 0;
#endif
  ...
  */
  ...
  VIASTDDECL SerializePDUData(uint32 /*in/out*/ *bufferLength
    , unsigned char /*out*/    *buffer) const = 0;
...
public:
    ...
    VIASTDDECL OnEthernetPacketError( VIATime time, VIAChannel channel, uint8 dir, uint32 errorCode, uint32 fcs, uint32 packetLength, const uint8 *packetData )=0;
};
...
public:
   ...
   VIASTDDECL OutputEthernetPacketWithFcs( VIAChannel channel, uint32 fcs, uint32 packetSize, const uint8 *packetData ) = 0;
   ...
   VIASTDDECL ConfigureEthernetPacketGenerator( VIAChannel channel, uint32 packetSize, const uint8 *packetData, uint32 transmissionRate, uint32 counterType, uint32 counterPosition) = 0;
...
public:
  ...
  VIASTDDECL OutputEthernetPacketAtTime(VIAChannel channel, const VIATime *sendTime, uint32 packetSize, const uint8 *packetData) const = 0;
#endif
  ...
  VIASTDDECL GetServiceDiscoveryIPv4MulticastEndpoint(bool /*in*/ vlan, uint32 /*in*/ vlanId, uint32* /*out*/ multicastIPv4Address, uint16* /*out*/ multicastPort) = 0;
  VIASTDDECL GetServiceDiscoveryIPv6MulticastEndpoint(bool /*in*/ vlan, uint32 /*in*/ vlanId, VIASocketAddress6* /*out*/ multicastIPv6Address, uint16* /*out*/ multicastPort) = 0;
#endif

#if defined (VIAEthernetMajorVersion) && (VIAEthernetMajorVersion >= 1) && (VIAEthernetMinorVersion) && (VIAEthernetMinorVersion >= 21)

  VIASTDDECL GetEthernetPacketCAPLData(void *caplEthernetPacket, unsigned char *buffer, uint32 bufferLength, uint32 *copiedLength) = 0;
#endif
   ...
   */
  VIASTDDECL ValidateMessage(VIASomeIpMessage* /* in */ someIpMessage, uint16 /* in */ serviceInstanceId, VIASomeIpMessage::ValidationState* /* out */ validationState) = 0;
  ...
  VIASTDDECL GetServiceDiscoveryMulticastEndpoint(bool /*in*/ vlan, uint32 /*in*/ vlanId, VIAEndpointAddr& endpoint, VIAAddressFamily wantedFamily = VIA_AF_UNDEF) const = 0;
#endif
...
{
public:
  VIASTDDECL GetSourceRemoteApplicationEndpoint(VIDBRemoteApplicationEndpoint** /*out*/ sourceRemoteApplicationEndpoint) = 0;
  VIASTDDECL GetDestinationRemoteApplicationEndpoint(VIDBRemoteApplicationEndpoint** /*out*/ dstRemoteApplicationEndpoint) = 0;
...
#if defined (VIAEthernetMajorVersion) && (VIAEthernetMajorVersion >= 1) && (VIAEthernetMinorVersion) && (VIAEthernetMinorVersion >= 23)
  VIASTDDECL GetMulticastEndpoint(VIAEndpointAddr& /*out*/ endpoint, VIAAddressFamily wantedFamily = VIA_AF_UNDEF) const = 0;
#endif
};
