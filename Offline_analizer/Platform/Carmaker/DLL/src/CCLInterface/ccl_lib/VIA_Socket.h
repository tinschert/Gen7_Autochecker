...
public:
    ...
    VIASTDDECL OnSocketSend( VIASocket2* pSocket, void* pParam, int32 result, int32 protocol, int8* pBuffer, uint32 size) = 0;

    // is called when data is received after receive method was called
    VIASTDDECL OnSocketReceive( VIASocket2* pSocket, void* pParam, int32 result, int32 protocol, const VIAEndpointAddr* pAddress, int8* pBuffer, uint32 size) = 0;
...
public:
  ...
  VIASTDDECL OnDtlsServerConnect(VIASocket2* socketHandle, const VIAEndpointAddr* pAddress, VIATlsSocketService::VIATlsResult result) = 0;
...
public:
  ...
  VIASTDDECL OnAdapterAddressAdded(uint32 ifIndex, const VIANetworkAddr* address, VIAAddressOrigin origin, const char *identification) = 0;
  VIASTDDECL OnAdapterAddressRemoved(uint32 ifIndex, const VIANetworkAddr* address, VIAAddressOrigin origin, const char *identification) = 0;
};
#endif
...
public:
    ...
    VIASTDDECL GetAdapterAddressCount( uint32 /*in*/ ifIndex, uint32* /*out*/ addrCount, VIAAddressFamily /*in*/ family = VIA_AF_UNDEF ) = 0;
    ...
    VIASTDDECL GetAdapterAddresses( uint32 /*in*/ ifIndex, VIANetworkAddr /*in*/ pAddress[], uint32* /*in-out*/ size, VIAAddressFamily /*in*/ family = VIA_AF_UNDEF ) = 0;

    // get the gateway address of the given address family (VIA_AF_INET or VIA_AF_INET6 allowed)
    VIASTDDECL GetAdapterGateway( uint32 /*in*/ ifIndex, VIAAddressFamily /*in*/ family, VIASockAddr* /*out*/ pAddress) = 0;
...
public:
  ...
  VIASTDDECL DeleteRoute( const VIANetworkAddr* /*in*/ destination, const VIANetworkAddr* /*in*/ gateway = nullptr) = 0;
  ...
  VIASTDDECL GetInterfaceParameter(uint32 /*in*/ ifIndex, const char* /*in*/ parameterName, int32* /*out*/ value) = 0;
...
public:
    // 
    VIASTDDECL OnSocketSend( VIASocket* pSocket, void* pParam, int32 result, int32 protocol, int8* pBuffer, uint32 size) = 0;
    // 
    VIASTDDECL OnSocketReceive( VIASocket* pSocket, void* pParam, int32 result, int32 protocol, uint32 address, uint16 port, int8* pBuffer, uint32 size) = 0;
    // 
    VIASTDDECL OnSocketReceive( VIASocket* pSocket, void* pParam, int32 result, int32 protocol, const VIASocketAddress6* pAddress, uint16 port, int8* pBuffer, uint32 size) = 0;
    // 
...
public:
    ...
    // the size of the array is given in parameter size. When the function returns the count of addresses
    // in the array is returned also in the parameter size
    VIASTDDECL GetAdapterAddresses( uint32 /*in*/ ifIndex, VIASocketAddress6 /*in*/ pAddress[], uint32* /*in-out*/ size ) = 0;
    ...
    VIASTDDECL GetAdapterSockAddresses( uint32 /*in*/ ifIndex, VIASocketAddress /*out*/ pAddresses[], uint32* /*in-out*/ size) = 0;
    // get the count of addresses of the given address family (VIA_AF_INET or VIA_AF_INET6 allowed)
    VIASTDDECL GetAdapterAddressCount( uint32 /*in*/ ifIndex, VIAAddressFamily /*in*/ family, uint32* /*out*/ addrCount ) = 0;
#endif
#endif
};
