...
public:
  ...
  VIASTDDECL GetAttributeValueString(uint64 attributeID, VIAFbAttributeRetrievalMode mode, char* valueBuffer, size_t bufferSize) const = 0;
...
public:
  ...
  VIASTDDECL CreateAttributeAccess(VIAFbAttributableType attributableType, const char* inPath, VIAFbAttributeAccess** outAttributeAccess) const = 0;
  ...
  // [IN] ID of the object
  // [OUT] attribute access or nullptr
  VIASTDDECL CreateAttributeAccess(VIAFbAttributableType attributableType, uint64 inId, VIAFbAttributeAccess** outAttributeAccess) const = 0;
  ...
  VIASTDDECL BindingErrorOccurred(int32 errorCode, const int32* subErrorCode, const char* bindingBlockName, const char* errorMessage, const char* objectPath) const = 0;
#endif
  ...
  // [THREADSAFE] No
  VIASTDDECL CreateDistributedObject(const char* inNamespacePath, const char* inName, const VIAFbDOBlueprint* inBlueprint, VIAFbDO** outDO, VIAFbDOCreationError* outErrorCode) = 0;
...
public:
  ...
  // [THREADSAFE] No
  VIASTDDECL GetMemberInterface(VIAFbDOMemberInterfaceType inInterfaceType, VIAFbDOMemberInterface** outInterface) = 0;
};
...
template<typename T>
inline VIAResult VIAQueryConstFbDOMemberInterface(const VIAFbDOMemberInterface* inInterfaceType, const T** outInterfaceType)
{
  if (outInterfaceType == nullptr) return kVIA_ParameterInvalid;
...
{
public:
  enum MemberInterfaceType { InterfaceType = eFbDOMemberIF_Generic };
...
{
public:
  enum MemberInterfaceType { InterfaceType = eFbDOMemberIF_Method };
...
{
public:
  enum MemberInterfaceType { InterfaceType = eFbDOMemberIF_MethodProvider };
...
{
public:
  enum MemberInterfaceType { InterfaceType = eFbDOMemberIF_MethodConsumer };
...
{
public:
  enum MemberInterfaceType { InterfaceType = eFbDOMemberIF_ConsumedMethod };
...
{
public:
  enum MemberInterfaceType { InterfaceType = eFbDOMemberIF_ProvidedMethod };
...
{
public:
  enum MemberInterfaceType { InterfaceType = eFbDOMemberIF_InternalMethod };
...
{
public:
  enum MemberInterfaceType { InterfaceType = eFbDOMemberIF_Data };
...
{
public:
  enum MemberInterfaceType { InterfaceType = eFbDOMemberIF_DataProvider };
...
{
public:
  enum MemberInterfaceType { InterfaceType = eFbDOMemberIF_DataConsumer };
...
{
public:
  enum MemberInterfaceType { InterfaceType = eFbDOMemberIF_ConsumedData };
...
{
public:
  enum MemberInterfaceType { InterfaceType = eFbDOMemberIF_ProvidedData };
...
{
public:
  enum MemberInterfaceType { InterfaceType = eFbDOMemberIF_InternalData };
...
{
public:
  enum MemberInterfaceType { InterfaceType = eFbDOMemberIF_Value };
...
{
public:
  enum MemberInterfaceType { InterfaceType = eFbDOMemberIF_ValueProvider };
...
{
public:
  enum MemberInterfaceType { InterfaceType = eFbDOMemberIF_ValueConsumer };
...
{
public:
  enum MemberInterfaceType { InterfaceType = eFbDOMemberIF_Event };
...
{
public:
  enum MemberInterfaceType { InterfaceType = eFbDOMemberIF_EventProvider };
...
{
public:
  enum MemberInterfaceType { InterfaceType = eFbDOMemberIF_EventConsumer };
...
{
public:
  enum MemberInterfaceType { InterfaceType = eFbDOMemberIF_ConsumedEvent };
...
{
public:
  enum MemberInterfaceType { InterfaceType = eFbDOMemberIF_ProvidedEvent };
...
{
public:
  enum MemberInterfaceType { InterfaceType = eFbDOMemberIF_InternalEvent };
...
{
public:
  enum MemberInterfaceType { InterfaceType = eFbDOMemberIF_Field };
...
{
public:
  enum MemberInterfaceType { InterfaceType = eFbDOMemberIF_FieldProvider };
...
{
public:
  enum MemberInterfaceType { InterfaceType = eFbDOMemberIF_FieldConsumer };
...
{
public:
  enum MemberInterfaceType { InterfaceType = eFbDOMemberIF_ConsumedField };
...
{
public:
  enum MemberInterfaceType { InterfaceType = eFbDOMemberIF_ProvidedField };
...
{
public:
  enum MemberInterfaceType { InterfaceType = eFbDOMemberIF_InternalField };
...
{
public:
  enum MemberInterfaceType { InterfaceType = eFbDOMemberIF_NetworkAttached };
...
{
public:
  enum MemberInterfaceType { InterfaceType = eFbDOMemberIF_Subscriber };
...
{
public:
  enum MemberInterfaceType { InterfaceType = eFbDOMemberIF_Announcer };
