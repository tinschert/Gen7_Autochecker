...
def TC_PER_FusionTest_Pedestrian():
    ...
    HTML_Logger.TestReportHeader("TestCaseID : TC_PER_FusionTest_Pedestrian")
    ...
    capl.TestWaitForTimeout(1000)
    capl.SetSignal("Customer_specific", "cm_scenario", r"Infra_scenarios\\PER_tests\\Fusion_Pedestrian")  # fill the scenario name
    capl.TestWaitForTimeout(1000)
