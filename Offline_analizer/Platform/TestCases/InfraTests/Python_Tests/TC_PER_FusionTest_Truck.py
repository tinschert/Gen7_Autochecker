...
def TC_PER_FusionTest_Truck():
    ...
    HTML_Logger.TestReportHeader("TestCaseID : TC_PER_FusionTest_Truck")
    ...
    capl.TestWaitForTimeout(1000)
    capl.SetSignal("Customer_specific", "cm_scenario", r"Infra_scenarios\\PER_tests\\Fusion_Truck")  # fill the scenario name
    capl.TestWaitForTimeout(1000)
