...
def TC_PER_FusionTest_Car_RAIN():
    ...
    HTML_Logger.TestReportHeader("TestCaseID : TC_PER_FusionTest_Car_RAIN")
    ...
    capl.TestWaitForTimeout(1000)
    capl.SetSignal("Customer_specific", "cm_scenario", r"Infra_scenarios\\PER_tests\\Fusion_Car_RAIN")  # fill the scenario name
    capl.TestWaitForTimeout(1000)
