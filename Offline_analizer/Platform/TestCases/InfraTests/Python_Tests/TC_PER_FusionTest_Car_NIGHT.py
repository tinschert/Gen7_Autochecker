...
def TC_PER_FusionTest_Car_Night():
    ...
    HTML_Logger.TestReportHeader("TestCaseID : TC_PER_FusionTest_Car_Night")
    ...
    capl.TestWaitForTimeout(1000)
    capl.SetSignal("Customer_specific", "cm_scenario", r"Infra_scenarios\\PER_tests\\Fusion_Car_NIGHT")  # fill the scenario name
    capl.TestWaitForTimeout(1000)
