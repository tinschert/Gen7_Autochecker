...
def TC_PER_FusionTest_Slanted_Car():
    ...
    HTML_Logger.TestReportHeader("TestCaseID : TC_PER_FusionTest_Slanted_Car")
    ...
    capl.TestWaitForTimeout(1000)
    capl.SetSignal("Customer_specific", "cm_scenario", r"Infra_scenarios\\PER_tests\\Fusion_Slanted_Car")  # fill the scenario name
    capl.TestWaitForTimeout(1000)
