...
def TC_PER_FusionTest_MultiObj_DUSK():
    ...
    HTML_Logger.TestReportHeader("TestCaseID : TC_PER_FusionTest_MultiObj_DUSK")
    ...
    capl.TestWaitForTimeout(1000)
    capl.SetSignal("Customer_specific", "cm_scenario", r"Infra_scenarios\\PER_tests\\Fusion_MultiObj_DUSK")  # fill the scenario name
    capl.TestWaitForTimeout(1000)
...
if __name__ == "__main__":
    TC_PER_FusionTest_MultiObj_DUSK()
