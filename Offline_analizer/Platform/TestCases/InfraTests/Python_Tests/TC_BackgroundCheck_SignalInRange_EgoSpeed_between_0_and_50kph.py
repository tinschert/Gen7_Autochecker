...
def TC_BackgroundCheck_SignalInRange_EgoSpeed_between_0_and_50kph():
    
    capl.Testcase_Start(__file__, "CANoePy Testcase", filename=HTML_Logger.generate_report_name()) #create the HTML report
    HTML_Logger.TestReportHeader("Example : CANoePy v1.1 BackgroundCheck_SignalInRange_EgoSpeed_between_0_and_50kph with ADAS HIL 2.xx")
    HTML_Logger.TestReportHeader("Tester : Ventsislav Negentsov")
    HTML_Logger.TestReportHeader("TestCaseID : TC_BackgroundCheck_SignalInRange_EgoSpeed_between_0_and_14_ms")
    ...
    capl.BackgroundCheck_SignalInRange("", "CarMaker/Car/v", 0.0, 14.2, 5000)   #background check for ego speed = 50kph for 5 seconds, refresh rate = default (check every 50ms)
...
if __name__ == "__main__":
    TC_BackgroundCheck_SignalInRange_EgoSpeed_between_0_and_50kph()
