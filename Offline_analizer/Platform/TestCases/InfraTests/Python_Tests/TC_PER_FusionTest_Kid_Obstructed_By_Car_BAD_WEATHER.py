...
def TC_PER_FusionTest_Kid_Obstructed_By_Car_BAD_WEATHER():
    ...
    HTML_Logger.TestReportHeader("TestCaseID : TC_PER_FusionTest_Kid_Obstructed_By_Car_BAD_WEATHER")
    ...
    capl.TestWaitForTimeout(1000)
    capl.SetSignal("Customer_specific", "cm_scenario", r"Infra_scenarios\\PER_tests\\Fusion_Kid_Obstructed_By_Car_BAD_WEATHER")  # fill the scenario name
    capl.TestWaitForTimeout(1000)
    ...
    #wait until we approach target (kid)
    capl.WaitForSignalInRange("","CarMaker/RB/TrafficObj/object0/dtx",20,23,20)
...
if __name__ == "__main__":
    TC_PER_FusionTest_Kid_Obstructed_By_Car_BAD_WEATHER()
