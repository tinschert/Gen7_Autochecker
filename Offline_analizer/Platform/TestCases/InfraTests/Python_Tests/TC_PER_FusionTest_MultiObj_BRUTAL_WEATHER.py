...
def TC_PER_FusionTest_MultiObj_BRUTAL_WEATHER():
    ...
    HTML_Logger.TestReportHeader("TestCaseID : TC_PER_FusionTest_MultiObj_BRUTAL_WEATHER")
    ...
    capl.TestWaitForTimeout(1000)
    capl.SetSignal("Customer_specific", "cm_scenario", r"Infra_scenarios\\PER_tests\\Fusion_MultiObj_BRUTAL_WEATHER")  # fill the scenario name
    capl.TestWaitForTimeout(1000)
    ...
    capl.SetSignal_Array("", "Classe_Obj_Sim/obj_ctrl.obj_target_v_long", [40, 20, 20, 20, 20, 20, 20, 20, 0, 0, 0])   #set target object to 40kph
...
if __name__ == "__main__":
    TC_PER_FusionTest_MultiObj_BRUTAL_WEATHER()
