...
def TC_PER_FusionTest_Car_RAIN_SUN_BLIND():
    ...
    HTML_Logger.TestReportHeader("TestCaseID : TC_PER_FusionTest_Car_RAIN_SUN_BLIND")
    ...
    capl.TestWaitForTimeout(1000)
    capl.SetSignal("Customer_specific", "cm_scenario", r"Infra_scenarios\\PER_tests\\Fusion_Car_RAIN_SUN_BLIND")  # fill the scenario name
    capl.TestWaitForTimeout(1000)
...
if __name__ == "__main__":
    TC_PER_FusionTest_Car_RAIN_SUN_BLIND()
