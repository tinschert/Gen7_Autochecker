...
def TC_PER_FusionTest_Animal_Bad_Weather():
    ...
    HTML_Logger.TestReportHeader("TestCaseID : TC_PER_FusionTest_Animal_Bad_Weather")
    ...
    capl.TestWaitForTimeout(1000)
    capl.SetSignal("Customer_specific", "cm_scenario", r"Infra_scenarios\\PER_tests\\Fusion_Animal_BAD_WEATHER")  # fill the scenario name
    capl.TestWaitForTimeout(1000)
...
if __name__ == "__main__":
    TC_PER_FusionTest_Animal_Bad_Weather()
