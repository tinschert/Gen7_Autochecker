...
def TC_PER_FusionTest_Kid_Obstructed_By_Car():
    ...
    HTML_Logger.TestReportHeader("TestCaseID : TC_PER_FusionTest_Kid_Obstructed_By_Car")
    ...
    capl.TestWaitForTimeout(1000)
    capl.SetSignal("Customer_specific", "cm_scenario", r"Infra_scenarios\\PER_tests\\Fusion_Kid_Obstructed_By_Car")  # fill the scenario name
    capl.TestWaitForTimeout(1000)
...
if __name__ == "__main__":
    TC_PER_FusionTest_Kid_Obstructed_By_Car()
