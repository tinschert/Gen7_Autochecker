...
def TC_PER_FusionTest_MultiObj_CLOUDY():
    ...
    HTML_Logger.TestReportHeader("TestCaseID : TC_PER_FusionTest_MultiObj_CLOUDY")
    ...
    capl.TestWaitForTimeout(1000)
    capl.SetSignal("Customer_specific", "cm_scenario", r"Infra_scenarios\\PER_tests\\Fusion_MultiObj_CLOUDY")  # fill the scenario name
    capl.TestWaitForTimeout(1000)
...
if __name__ == "__main__":
    TC_PER_FusionTest_MultiObj_CLOUDY()
