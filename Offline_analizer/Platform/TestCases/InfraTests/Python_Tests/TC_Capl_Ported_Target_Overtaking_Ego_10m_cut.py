...
def Target_Overtaking_Ego_10m_cut(config, ego_speed, tgt_speed, vehicle_code):
    ...
    HTML_Logger.TestReportHeader("TestCaseID : Target_Overtaking_Ego_10m_cut")
...
if __name__ == "__main__":
    ...
    # 12->Replay_DPCdelta5
    # 13->Replay_DPCalpha2
    Target_Overtaking_Ego_10m_cut(2, 50, 60, 0)
