...
def TC_PER_FusionTest_MultiObj_UltraHeavyTraffic():
    ...
    HTML_Logger.TestReportHeader("TestCaseID : TC_PER_FusionTest_MultiObj_UltraHeavyTraffic")
    ...
    capl.TestWaitForTimeout(1000)
    capl.SetSignal("Customer_specific", "cm_scenario", r"Infra_scenarios\\PER_tests\\Fusion_MultiObj_UltraHeavyTraffic")  # fill the scenario name
    capl.TestWaitForTimeout(1000)
    ...
    tf.Set_Ego_Vehicle_Velocity(128.0)  # set 40kph
    ...
    capl.TestWaitForTimeout(20000)
    capl.SetSignal("", "hil_ctrl/Ego_lane_offset", 3.5)  # move left lane
    capl.TestWaitForTimeout(2000)
    capl.SetSignal("", "hil_ctrl/Ego_lane_offset", 10.5)  # move left lane
    tf.Set_Ego_Vehicle_Velocity(90.0)  # set 40kph
    capl.TestWaitForTimeout(20000)
...
if __name__ == "__main__":
    TC_PER_FusionTest_MultiObj_UltraHeavyTraffic()
