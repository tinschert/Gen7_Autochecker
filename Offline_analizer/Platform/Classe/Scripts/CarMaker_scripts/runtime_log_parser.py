...
def get_latest_log():
    """ Get the latest log file inside SimOutput dir"""
...
def parse_error_log(error_log_file) -> None:
    """
    Parse given log file for errors

    Args:
      error_log_file (str): Error log file that shall be parsed
    Returns:
    """
