#ifndef CBRAKESYSTEM_H
#define CBRAKESYSTEM_H
/*!
********************************************************************************
@class CBrakeSystem
@ingroup driveTrain
@brief Brake system model
...
********************************************************************************
@param[out] o_MWheelRightFront       [Nm]      brake torque wheel right-front
@param[out] o_MWheelLeftFront        [Nm]      brake torque wheel left-front
@param[out] o_MWheelRightRear        [Nm]      brake torque wheel right-rear
@param[out] o_MWheelLeftRear         [Nm]      brake torque wheel left-rear
...
namespace CBrakeSystemDoc
{
    const auto o_MWheelRightFront = "[Nm]  brake torque wheel right-front";
    const auto o_MWheelLeftFront = "[Nm]  brake torque wheel left-front";
    const auto o_MWheelRightRear = "[Nm]  brake torque wheel right-rear";
    const auto o_MWheelLeftRear = "[Nm]  brake torque wheel left-rear";
...
class CBrakeSystem : public CModule<>
{
    //*********************************
...
public:
private:
    CFloat m_pBrakeRightFront;
    CFloat m_pBrakeLeftFront;
    CFloat m_pBrakeRightRear;
    CFloat m_pBrakeLeftRear;
    CFloat m_MparkingBrake;
};

#endif // CBRAKESYSTEM_H
