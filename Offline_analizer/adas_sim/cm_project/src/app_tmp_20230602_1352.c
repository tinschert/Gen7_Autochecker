...
static const char *CompileLibs[] = {
    ...
    "libcar.a	CarMaker-Car win64 11.1 2022-10-19",
    "libcarmaker.a	CarMaker win64 11.1 2022-10-19",
    "libipgdriver.a	IPGDriver win64 11.0 2022-03-28",
    "libipgroad.a	IPGRoad win64 11.1 2022-10-18",
...
static const char *CompileFlags[] = {
    "-m64 -O3 -DNDEBUG -DWIN32 -DWIN64 -DCM_NUMVER=110100",
...
tAppStartInfo   AppStartInfo = {
    "CarMaker 11.1 - Car_Generic",          /* App_Version         */
    "3",          /* App_BuildVersion    */
    "jetbrains",     /* App_CompileUser     */
    "b979f2f8d573",         /* App_CompileSystem   */
    "2022-10-19 14:39:39",  /* App_CompileTime */
