...
*   mex '-IC:/IPG/carmaker/win64-12.0/include' '-DLINUX' '-DLINUX64' tire_lin.c
*   mex '-IC:/IPG/carmaker/win64-12.0/include' '-DWIN32' '-DWIN64'   tire_lin.c
*/
...
#include <simulink-ipg.c>  /* MEX-file interface mechanism */
#else
