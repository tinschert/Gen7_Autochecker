...
static const char *CompileLibs[] = {
    ...
    "libcar.a	CarMaker-Car win64 12.0 2023-03-28",
    "libcarmaker.a	CarMaker win64 12.0 2023-03-28",
    "libipgdriver.a	IPGDriver win64 12.0 2023-03-24",
    "libipgroad.a	IPGRoad win64 12.0 2023-03-24",
...
static const char *CompileFlags[] = {
    "-m64 -O3 -DNDEBUG -DWIN32 -DWIN64 -DCM_NUMVER=120000",
...
tAppStartInfo   AppStartInfo = {
    "CarMaker 12.0 - Car_Generic",          /* App_Version         */
    "3",          /* App_BuildVersion    */
    "jetbrains",     /* App_CompileUser     */
    "9fd539ca6533",         /* App_CompileSystem   */
    "2023-03-28 13:44:45",  /* App_CompileTime */
