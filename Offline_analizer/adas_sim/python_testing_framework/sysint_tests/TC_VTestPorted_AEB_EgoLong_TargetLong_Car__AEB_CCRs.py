...
def AEB_EgoLong_TargetLong_Car__AEB_CCRs(config, ego_speed, tgt_speed):
  ...
  tf.Precondition_CM_TestPrep(config,3,0)
  tf.PreConditionsAEB()
  tf.Init_Ego_vehicle()
  tf.Set_Ego_Vehicle_AEB(ego_speed, tgt_speed)
  tf.Check_AEB_TIPL_Long_Status_Cus(config)
...
if __name__ == "__main__":
    ...
    # 12->Replay_DPCdelta5
    # 13->Replay_DPCalpha2
    #AEB_EgoLong_TargetLong_Car__AEB_CCRs(5,30,0)
    AEB_EgoLong_TargetLong_Car__AEB_CCRs(5, 50, 10)