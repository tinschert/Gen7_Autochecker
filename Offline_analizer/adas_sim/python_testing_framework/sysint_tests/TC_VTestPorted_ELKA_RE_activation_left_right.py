...
def ELKA_RE_activation_left_right(config, ego_speed, tgt_speed):
  ...
  tf.Precondition_CM_TestPrep(config, 13, 0)
  ...
  tf.Check_ELKA_RoadEdge_Status_Cus(config)
...
if __name__ == "__main__":
    ...
    # 12->Replay_DPCdelta5
    # 13->Replay_DPCalpha2
    ELKA_RE_activation_left_right(5,70,50)