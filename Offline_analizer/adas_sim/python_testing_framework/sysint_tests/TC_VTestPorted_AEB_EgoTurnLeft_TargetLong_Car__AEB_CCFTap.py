...
def AEB_EgoTurnLeft_TargetLong_Car__AEB_CCFTap(config, ego_speed, tgt_speed):
  ...
  tf.Precondition_CM_TestPrep(config, 6, 0)
  tf.PreConditionsAEB()
  ...
  capl.WaitForSignalInRange("","CarMaker/RB/TrafficObj/object0/rel_dx", 0,150,25)
  capl.SetSignal("","hil_ctrl/trigger_tgt_collision_turnlong", 0)
  tf.Set_Indicate_Left()
  tf.Check_AEB_Turn_Status_Cus(config)
  tf.Set_Indicator_Inactive()
...
if __name__ == "__main__":
    ...
    # 12->Replay_DPCdelta5
    # 13->Replay_DPCalpha2
    AEB_EgoTurnLeft_TargetLong_Car__AEB_CCFTap(5,18,10)