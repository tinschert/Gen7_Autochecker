...
def AES_EgoLong_TargetLong_Car__AEB_CCRs(config, ego_speed, tgt_speed):
  ...
  tf.Precondition_CM_TestPrep(config, 7, 0)
  tf.PreConditionsAEB()
  tf.Set_Ego_Vehicle_AEB(ego_speed, tgt_speed)
  tf.Check_AES_Status_Cus(config)
...
if __name__ == "__main__":
    ...
    # 12->Replay_DPCdelta5
    # 13->Replay_DPCalpha2
    AES_EgoLong_TargetLong_Car__AEB_CCRs(2,60,0)