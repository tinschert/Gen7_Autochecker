...
def AEB_EgoLong_TargetOncoming_same_lane__AEB_CCFhos(config, ego_speed, tgt_speed):
  ...
  tf.Precondition_CM_TestPrep(config, 5, 0)
  tf.PreConditionsAEB()
  tf.Set_Ego_Vehicle_AEB(ego_speed, tgt_speed)
  tf.Check_AEB_TIPL_Long_Oncoming_Status_Cus(config)
...
if __name__ == "__main__":
    ...
    # 12->Replay_DPCdelta5
    # 13->Replay_DPCalpha2
    AEB_EgoLong_TargetOncoming_same_lane__AEB_CCFhos(2,50,50)