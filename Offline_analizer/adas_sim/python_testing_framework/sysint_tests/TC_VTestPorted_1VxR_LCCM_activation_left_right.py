...
def LCCM_activation_left_right(config, ego_speed, tgt_speed):
  ...
  #capl.SetSignal("", "hil_ctrl/jenkins_control", 1)

  tf.Precondition_CM_TestPrep(config, 9, 0)
  tf.PreConditions_LKA()
  capl.SetSignal("","hil_drv/target_velocity", ego_speed)
  capl.SetSignal("","hil_ctrl/trigger_tgt_collision_blindspot", 0)
...
if __name__ == "__main__":
    ...
    # 12->Replay_DPCdelta5
    # 13->Replay_DPCalpha2
    LCCM_activation_left_right(2,70,30)