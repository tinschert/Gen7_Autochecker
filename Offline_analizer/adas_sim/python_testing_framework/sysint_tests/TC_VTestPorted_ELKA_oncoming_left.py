...
def ELKA_oncoming_left(config, ego_speed, tgt_speed):
  ...
  tf.Precondition_CM_TestPrep(config, 12, 0)
  ...
  capl.WaitForSignalInRange("","CarMaker/RB/TrafficObj/object0/rel_dx", 0, 170, 25)
  capl.SetSignal("","hil_ctrl/trigger_tgt_collision_oncoming", 0)
  capl.TestWaitForTimeout(500)
  capl.SetSignal("","hil_drv/steering_wheel_angle_req", -5)
  tf.Check_ELKA_Oncoming_Status_Cus(config)
